...
const timeframeParse = (value: string | null) => (value && value.length > 0 ? value : "7d");
const segmentParse = (value: string | null) => (value && value.length > 0 ? value : "all");
const stringSerialize = (value: string) => value;
...
export default function MonitoringPage() {
  const [timeframe, setTimeframe] = useQueryState<string>("tf", {
    parse: timeframeParse,
    serialize: stringSerialize,
    defaultValue: "7d",
  });
  const [segment, setSegment] = useQueryState<string>("seg", {
    parse: segmentParse,
    serialize: stringSerialize,
    defaultValue: "all",
  });
